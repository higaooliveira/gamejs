...
const update = function (modifier){
	if(38 in keysDown){ // Pressionando a seta cima
		hero.y -= hero.speed * modifier;
	}
	if(40 in keysDown) { // Pressionando a seta baixo
		hero.y += hero.speed * modifier;	
	}
	if(37 in keysDown) { // Pressionando a seta esquerda
		hero.x -= hero.speed * modifier;	
	}
	if(39 in keysDown) { // Pressionando a seta direita
		hero.x += hero.speed * modifier;	
	}
